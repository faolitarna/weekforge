...
| 1 | [Extraction](./steps/step-1-extraction.md) | `summarize_week` — first real feature (index → sub-steps 1a–1f) | ✅ |
| 1a | [Context & CLI](./steps/step-1a-context-and-cli.md) | Prompts dir, DB IDs, user-profile Notion page + loader, `summarize-week <week>` CLI | ✅ |
| 1b | [Tier-0 Extraction](./steps/step-1b-tier0-extraction.md) | Thin Tier-0 block/comment collection + checkbox arithmetic | ✅ |
| 1c | [Summary Agent & Workflow](./steps/step-1c-summary-agent.md) | `summarize_week_agent`, workflow, single HITL accept gate with feedback loop | ✅ |
